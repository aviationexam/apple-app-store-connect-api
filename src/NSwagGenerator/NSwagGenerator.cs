        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var generator = new CSharpClientGenerator(openApi, new CSharpClientGeneratorSettings
        {
            ...
            OperationNameGenerator = settings.OperationGenerationMode switch
            {
                ...
                "MultipleClientsFromFirstTagAndPathSegmentsOperation" =>
                ...
                "MultipleClientsFromFirstTagAndOperationName" =>
                    new MultipleClientsFromFirstTagAndOperationNameGenerator(),
                _ => throw new NotImplementedException(
                    $"OperationGenerationMode: {settings.OperationGenerationMode} is not implemented."),
            },
            ...
            GeneratePrepareRequestAndProcessResponseAsAsyncMethods =
                settings.GeneratePrepareRequestAndProcessResponseAsAsyncMethods,
